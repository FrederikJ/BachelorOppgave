...
namespace HovedOppgave.Classes
{
    ...
    //
    //  Note: However, you are required to acknowledge in your application that you are using GemBox.Spreadsheet 
    //  Free for specific purpose and you need to provide a link to GemBox.Spreadsheet or GemBox.Spreadsheet 
    //  Free page. You can format and formulate the acknowledgement in any way you like. For example, if
    //  you have created web application, you can put exported to XLSX/XLS/ODS/CSV/HTML/PDF/XPS using 
    //  GemBox.Spreadsheet Free .NET component link on the bottom of export data (or similar) page.
    //
    //  GemBox.Spreadsheet is a .NET component that enables developers to read, write, convert and print 
    //  spreadsheet files (XLSX, XLS, ODS, CSV, HTML, PDF or XPS) from their .NET applications using one 
    //  simple API. GemBox.Spreadsheet Free is free of charge.
    //
    //
    // Eksempler og andre dokumentasjon finner du http://www.gemboxsoftware.com/SampleExplorer/Spreadsheet?tab=cs
    ...
    public class Export
    {
        public static void ToPDF()
        {
            ...
            ef.Save("Hello World.pdf");
        }

        public static void ToCVS()
        {
            //Eksempel
            // If using Professional version, put your serial key below.
            SpreadsheetInfo.SetLicense("FREE-LIMITED-KEY");
    ...
    #region annen mulighet for export til excel hentet fra systemutvikling prosjeket
